...
SHELL
    c.vm.provision 'shell', name: 'gateway', path: 'provisioners/shell/gateway.sh',
                   args: ['192.168.101.0/24', '172.16.1.10', '172.16.2.10', '192.168.255.1', '192.168.255.2']
  end
...
SHELL
    c.vm.provision 'shell', name: 'gateway', path: 'provisioners/shell/gateway.sh',
                   args: ['192.168.102.0/24', '172.16.2.10', '172.16.1.10', '192.168.255.2', '192.168.255.1']
  end
